...
5. **Write the artifacts.** One `{taskid-title}/task.md` per task from [task-template.md](task-template.md). Strip the `//` comment lines. Every task starts at **Status** `Not started`;
